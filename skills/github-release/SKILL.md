...
7. 对同名 tag 创建或更新 GitHub Release，上传 `DshMobile-v0.2.0-release.apk`。
...
```bash
gh release create v0.2.0 apps/mobile/android/app/build/outputs/apk/release/app-release.apk --generate-notes --title "dsh-mobile v0.2.0"
```

已有 Release 时改用：

```bash
gh release upload v0.2.0 apps/mobile/android/app/build/outputs/apk/release/app-release.apk --clobber
```
